...
const HeroCurtainContent = () => {
  ...
  const conditionnalBoxesStyle = `animate-grow hover:transition-all ease-in-out hover:duration-500 hidden sm:flex border-[2px] w-[2ch] h-[2ch] sm:w-[3ch] sm:h-[3ch] border-darkflo dark:border-white items-center justify-center`;
  const lineContainer = `font-semibold text-2xl sm:text-4xl flex gap-1 sm:gap-3`;
