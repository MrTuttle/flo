...
const HeroCurtainContent = () => {
  ...
  const boxesStyle = ` flex border-[3px] w-[5rem] h-[5rem] sm:w-[7rem] sm:h-[7rem] border-darkflo dark:border-white items-center justify-center`;
  const conditionnalBoxesStyle = `hidden sm:flex border-[3px] w-[5rem] h-[5rem] sm:w-[7rem] sm:h-[7rem] border-darkflo dark:border-white items-center justify-center`;
